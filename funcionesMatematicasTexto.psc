Algoritmo FuncionesMatematicasTexto
...
Escribir "El primer carácter de cadena1 es: " subcadena(cadena1,1,1);
Escribir "La cadena1 en mayúsculas es: " mayusculas(cadena1);
Escribir "La cadena2 en minusculas es: " minusculas(cadena2);
Escribir "La cadena concatenada queda como: La ", concatenar(cadena1," es muy interesante.");
